...
class PaperCreate(PaperBase): 
    ...
    references: Optional[List[Dict[str, Any]]] = Field(None, description="List of references with titles and URLs")
    ...
    pdf_processing_data: Optional[datetime] = Field(None, description="When PDF was processed")
