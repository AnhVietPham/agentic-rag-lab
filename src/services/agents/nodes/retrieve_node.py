...
async def ainvoke_retrieve_step(
    ...
    if runtime.context.langfuse_enabled and runtime.context.trace:
        try: 
            ...
            logger.debug("Created Langfuse span for retrieval initiation")
    ...
    updates["retrieval_attempts"] = new_attempts_count
    logger.info(f"Retrieval attempt {new_attempts_count}/{max_attempts}")
    ...
    updates["messages"] = [
        AIMessage(
            ...
            tool_calls=[
                {
                    "id": f"retrieve_{new_attempts_count}",
