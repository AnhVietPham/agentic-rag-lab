...
- 60-79: CS/AI/ML research scope — including broad field questions that arXiv papers can answer (e.g., "What is machine learning?", "Tell me about attention mechanisms", "What are LLM agents in NLP research?")
- 40-59: Borderline or ambiguous — might touch CS/ML but too vague to justify paper retrieval (e.g., "What is learning?" with no technical context, "Explain agents" without AI/CS framing)
