...
class AgenticRAGService: 
    ...
    def _build_graph(self): 
        logger.info("Building LangGraph workflow with context_scheme")
            ...
            if trace is not None:
                with trace as trace_obj:
                    ...
                    try:
                        ...
                        # Span is ended by the context manager; do not call trace.end() in _run_workflow
    ...
    def _extract_reasoning_steps(self, result: dict) -> List[str]: 
        ...
        if retrieval_attempts > 0 or grading_results:
            steps.append("Generated answer from retrieved papers")
        else:
            steps.append("Completed without document retrieval")
