...
def make_opensearch_client_fresh(settins: Optional[Settings] = None, host: Optional[str] = None) -> OpenSearchClient: 
    ...
    opensearch_host = host or settins.opensearch.host

    return OpenSearchClient(host=opensearch_host, settings=settins)