...
from src.services.pdf_parser.factory import PDFParserService

logger = logging.getLogger(__name__)

class MetadataFetcher: 
    """Service for fetching arXiv papers with PDF processing and database storag"""
    ...
    async def fetch_and_process_paper(
        ...
        try: 
            # Step 1: Fetch papers metadata from arXiv 
        ...
        try: 
            ...
            async with download_semaphore:
                ...
                if pdf_path: 
                    ...
                    logger.debug(f"Downloaded complete: {paper.arxiv_id}")
                else: 
    ...
    def _serialize_parsed_paper(self, parsed_paper: ParsedPaper) -> Dict[str, Any]: 
        ...
        try: 
            ...
            return {
                ...
                "pdf_processed": True,
                "pdf_processing_data": datetime.now(),
            }
        except Exception as e:
    ...
    def _store_papers_to_db(
        ...
        for paper in papers:
            try: 
                ...
                if parsed_paper:
                    parsed_content = self._serialize_parsed_paper(parsed_paper)
