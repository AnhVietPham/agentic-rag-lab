...
# arXiv recommends including User-Agent with contact info to reduce rate limiting
ARXIV_USER_AGENT = "production-agentic-rag-arxiv-ingestion/1.0 (mailto:rivenpham@gmail.com)"
...
class ArxivClient: 
    ...
    def _parse_single_entry(self, entry: ET.Element) -> Optional[ArxivPaper]:
        ...
        try: 
            ...
            logger.error(f"Failed to parse single entry: {e}")
            return None
